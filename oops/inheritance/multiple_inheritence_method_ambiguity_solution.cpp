...
public:
    ...
    using Mammal::eat; //This will make sure that only Mammal::eat() will be called
};
...
int main(){
    ...
    Whale whale;
    whale.eat(); //Now, this will not lead to ambiguity in eat() resolution during compile time
